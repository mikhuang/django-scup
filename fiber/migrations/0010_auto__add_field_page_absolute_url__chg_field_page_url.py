...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Page.absolute_url'
        db.add_column('fiber_page', 'absolute_url', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Page.absolute_url'
        db.delete_column('fiber_page', 'absolute_url')
    ...
    models = {
        ...
        'fiber.page': {
            ...
            'absolute_url': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
